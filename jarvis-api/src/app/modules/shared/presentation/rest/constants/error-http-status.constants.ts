...
export const ERROR_CODE_TO_HTTP_STATUS: Record<ErrorCodes, number> = {
  ...
  [ErrorCodes.WORKSPACE_ALREADY_EXISTS]: 409,
  [ErrorCodes.WORKSPACE_SLUG_ALREADY_EXISTS]: 409,
  [ErrorCodes.WORKSPACE_CREATION_FAILED]: 500,
  [ErrorCodes.WORKSPACE_UPDATE_FAILED]: 500,
  [ErrorCodes.WORKSPACE_DELETION_FAILED]: 500,
  [ErrorCodes.WORKSPACE_RETRIEVAL_FAILED]: 500,
  [ErrorCodes.WORKSPACE_LISTING_FAILED]: 500,
  [ErrorCodes.WORKSPACE_PERSISTENCE_ERROR]: 500,
};
